...
genTypes = ['man','male','boy','stepbro','woman','female','girl','stepsis','babe','noob','bacon','short','tiny','small','long','large','huge','rare','exclusive','visor','pizelcat','haven','sazz','kalani','lamp']
